...
def snake_case(data):
     '''
    Функция для приведения значений к формату 'snake_case'.
    Автоматически определяет тип данных: названия столбцов/значения в колонке 
    и применяет необходимые преобразования.
    '''
